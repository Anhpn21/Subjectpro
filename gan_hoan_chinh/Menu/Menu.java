...
public class Menu {
    ...
    static void menuMain() {
        ...
        System.out.println("-= 4. Đơn thuốc         =-");
    ...
    static void menuSub(int luachon) {
        switch (luachon) {
            ...
            case 3:
                ...
                System.out.println("-= 3. Cập nhật thuốc            =-");
                System.out.println("-= 4. Hiển thị tất cả số Thuốc  =-");
            ...
            case 4:
                ...
                System.out.println("-= 1. Viết đơn thuốc           =-");
                System.out.println("-= 2. Hiển thị tất cả đơn      =-");
    ...
    public static void main(String[] args) {
        String fileDoctor = "Bacsi.txt";
        String fileDrug = "Khothuoc.txt";
        String filePatient = "Benhnhan.txt";
        String fileDon = "Donthuoc.txt";
                    ...
                    switch(luachon){
                        case 1:
                            ...
                            do {
                                ...
                                tmp1 = lPatient.find(ID);
                                valid = ID.matches("^BN\\d{3}$");
                                if (tmp1 < 0) {
                                    System.out.println("**ID patient is not exist!!");
                                }
                                if (!valid) {
                                    System.out.println("**Hint form ID: T + 3 digits");
                                }
                            } while (tmp1 < 0 || !valid);
                            String name = lPatient.getNameP(ID);
                            String des = lPatient.getDeseaseP(ID);
                            lDrug.addNewD(ID, name, des);
                            break;
                        case 2:  //hiển thị tất cả đơn
                            lDrug.displayDon();
                            break;
                        case 3:
                            lDrug.SaveFileDon(fileDon);
